...
public class MoveCommandHelper {
  ...
  /**
   * Method that takes the column input of the player bookshelf and returns the list of the first
   * available empty coordinates.
   *
   ...
   */
  public static List<Coordinates> fromColIdxToCoord(String idx, Bookshelf bs, Integer nMoves)
      throws BookshelfGridColIndexOutOfBoundsException,
