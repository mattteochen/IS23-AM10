...
public interface UserInterface {
  ...
  /**
   * Method used to retrieve the strings the user might have sent trough their input interface. GUI
   * adds these strings on button clicks while CLI adds them on return.
   *
  ...
  /**
   * Method to display a quick help guide to explain how to join the games or create one. In GUI
   * enables buttons.
   */
  void displayGameJoinGuide();

  /**
   * Method called when the user wants to join an existing game and has to pick between the
   * available ones. It assumes to receive only valid games.
   *
