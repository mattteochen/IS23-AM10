...
public class RMIClient extends Client {
   ...
   */
  public RMIClient(
      PlayerConnectorRmi pc,
      UserInterface ui,
      IPlayerConnector pcs,
      IServerControllerAction scas,
      Registry reg)
  ...
  /**
   * Perform all the needed lookups. A gentle reminder that the {@link IPlayerConnector} bind can
   * only be found after a join or creation action.
   */
  @Override
  protected void lookupInit() throws RemoteException, NotBoundException {
    playerConnectorServer =
        (IPlayerConnector)
            rmiRegistry.lookup(
                ServerControllerRmiBindings.getPlayerConnectorRebindId(
  ...
  /**
   * Method override that creates and starts message handler thread. To be started after the {@link
   * RMIClient#lookupInit}.
   */
  @Override
