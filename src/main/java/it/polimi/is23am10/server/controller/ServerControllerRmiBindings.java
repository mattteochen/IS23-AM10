...
public final class ServerControllerRmiBindings {
   ...
   */
  public static void setServerControllerActionServer(IServerControllerAction s)
      throws NullRmiServerException {
    if (s == null) {
   ...
   */
  public static void setServerControllerActionStub(IServerControllerAction s)
      throws NullRmiServerException {
    if (s == null) {
   ...
   */
  public static void rebindServerControllerAction(IServerControllerAction sca)
      throws RemoteException {
    ServerControllerRmiBindings.setServerControllerActionServer(sca);
    ServerControllerRmiBindings.setServerControllerActionStub(
        (IServerControllerAction) UnicastRemoteObject.exportObject(sca, DONT_CARE));
    ServerControllerRmiBindings.getRmiRegistry()
        .rebind(
            IServerControllerAction.class.getName(),
