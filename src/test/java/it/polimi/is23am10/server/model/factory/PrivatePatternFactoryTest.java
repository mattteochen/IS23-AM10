...
class PrivatePatternFactoryTest {
  ...
  public void RULE1_should_find_ZERO_matches()
    ...
    Bookshelf testPattern1ZeroMatches =
        new Bookshelf("CCCGF" + "FTBFF" + "FCCFF" + "CFGFT" + "PPCBC" + "BCFPC");
  ...
  public void RULE1_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern1 =
        new Bookshelf("PCFGF" + "FTBFC" + "FCCBF" + "CGGFT" + "PPCBC" + "BCTPC");
  ...
  public void RULE2_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern2ZeroMatches =
        new Bookshelf("CCBGF" + "FFBFC" + "FCFGF" + "CBGFF" + "PPCFC" + "BCBPB");
  ...
  public void RULE2_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern2 =
        new Bookshelf("CCBGF" + "FPBFC" + "CCGGF" + "CBGFB" + "PPCTC" + "BCBPF");
  ...
  public void RULE3_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern3ZeroMatches =
        new Bookshelf("CCBGF" + "BTBBC" + "FCBGF" + "CBGFB" + "PPCBC" + "FCBPC");
  ...
  public void RULE3_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern3 =
        new Bookshelf("CCBGF" + "FTBGC" + "FCPGF" + "CCGFT" + "PPCBC" + "BCBPC");
  ...
  public void RULE4_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern4ZeroMatches =
        new Bookshelf("CCBGF" + "FTBFC" + "BCBGF" + "CBGBT" + "PCBFC" + "BCBPC");
  ...
  public void RULE4_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern4 =
        new Bookshelf("CCBGG" + "FTBFC" + "TCFGF" + "CBGPT" + "PBCBC" + "BCBPC");
  ...
  public void RULE5_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern5ZeroMatches =
        new Bookshelf("CCBGF" + "FCBFC" + "FCCGF" + "CCCFT" + "PPCBC" + "BCBBC");
  ...
  public void RULE5_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern5 =
        new Bookshelf("CCBGF" + "FTBFC" + "FCCGF" + "CFBFT" + "PPCBP" + "GCBCC");
  ...
  public void RULE6_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern6ZeroMatches =
        new Bookshelf("CCFGF" + "FTBFC" + "FCCFF" + "CBGFT" + "PFCBC" + "FCBPC");
  ...
  public void RULE6_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern6 =
        new Bookshelf("CCTGC" + "FTBFC" + "FCCBF" + "CBGFT" + "PGCFC" + "PCBPC");
  ...
  public void RULE7_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern7ZeroMatches =
        new Bookshelf("FCBGF" + "FTBBC" + "FBCGF" + "BBGFT" + "PPCBB" + "BCFPC");
  ...
  public void RULE7_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern7 =
        new Bookshelf("CCBGF" + "FTBFC" + "FPCGF" + "TBGFT" + "PPCBG" + "BCBPC");
  ...
  public void RULE8_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern8ZeroMatches =
        new Bookshelf("CCBGB" + "FBBFC" + "FCBGF" + "BBGFT" + "PPCCC" + "BCBCC");
  ...
  public void RULE8_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern8 =
        new Bookshelf("CCBGF" + "FCBFC" + "FCTGF" + "PBGFT" + "PPCBC" + "BCBGC");
  ...
  public void RULE9_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern9ZeroMatches =
        new Bookshelf("CCPGF" + "FTBFC" + "FCPGF" + "CBGFP" + "PBCBB" + "PCBPC");
  ...
  public void RULE9_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern9 =
        new Bookshelf("CCGGF" + "FTBFC" + "FCCGF" + "CBGFB" + "PTCBP" + "FCBPC");
  ...
  public void RULE10_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern10ZeroMatches =
        new Bookshelf("CCBGP" + "FPBFC" + "PCCGF" + "CBGPT" + "PPCFC" + "BCBBC");
  ...
  public void RULE10_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern10 =
        new Bookshelf("CCBGT" + "FGBFC" + "BCCGF" + "CBGCT" + "PFCFC" + "BCBPC");
  ...
  public void RULE11_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern11ZeroMatches =
        new Bookshelf("CCFGF" + "FFBFC" + "FCCGF" + "CBBFT" + "PPCBB" + "BCBBC");
  ...
  public void RULE11_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern11 =
        new Bookshelf("CCPGF" + "FBBFC" + "GCCGF" + "CBFFT" + "PPCBC" + "BCBTC");
  ...
  public void RULE12_should_find_ZERO_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern12ZeroMatches =
        new Bookshelf("CCFGF" + "FFBFC" + "FCBGF" + "CBGBT" + "PPCBB" + "BCBPC");
  ...
  public void RULE12_should_find_SIX_matches()
      throws WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException,
          NullPointerException {
    Bookshelf testPattern12 =
        new Bookshelf("CCBGF" + "FPBFC" + "FCFGF" + "CBGTT" + "PPCBG" + "CCBPC");
  ...
  public void TEST_GET_RANDOM_PRIVATECARDS_no_duplicates()
    ...
    List<PrivatePattern<Function<Bookshelf, Integer>>> allUsedPatterns =
        game.getPlayers().stream()
            .map(player -> player.getPrivateCard().getPattern())
            .distinct()
