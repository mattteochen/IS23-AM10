...
public class SharedPatternFactoryTest {
  ...
  public void TWO_ADJACENTS_RULE_satisfied()
    ...
    Bookshelf twoAdjacentMatching =
        new Bookshelf("CCBGF" + "FTBFC" + "FCCGF" + "CBGFT" + "PPCBC" + "BCBPC");
    Bookshelf twoAdjacentAllEqualsMatching =
        new Bookshelf("CCCCC" + "CCCCC" + "CCCCC" + "CCCCC" + "CCCCC" + "CCCCC");
    Bookshelf twoAdjacentNotMatching =
        new Bookshelf("CBGFT" + "BGFTC" + "GFTCB" + "FTCBG" + "TCBGF" + "CBGFT");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
    Bookshelf withHorizontalOverlappingBookshelf =
        new Bookshelf("XCCCX" + "XXXXX" + "XCCCX" + "XXXXX" + "XCCCX" + "XXXXX");
    Bookshelf withVerticalOverlappingBookshelf =
        new Bookshelf("XCXCX" + "XCXCX" + "XCXCX" + "XXCXX" + "XXCXX" + "XXCXX");
  ...
  public void FOUR_CORNERS_RULE_satisfied()
      throws NullPointerException,
          ...
          WrongCharBookshelfStringException {
    Bookshelf fourCornersMatching =
        new Bookshelf("CBBBC" + "BBBBB" + "BBBBB" + "BBBBB" + "BBBBB" + "CBBBC");
    Bookshelf fourCornersNotMatching =
        new Bookshelf("CBBBB" + "BBBBB" + "BBBBB" + "BBBBB" + "BBBBB" + "CBBBC");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
  ...
  public void FOUR_ADJACENTS_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf fourAdjacentsMatching =
        new Bookshelf("CCCCB" + "FTTTT" + "BFGCG" + "FFFFG" + "TTBCG" + "GGGTG");
    Bookshelf fourAdjacentsNotMatching =
        new Bookshelf("CBGFT" + "BGFTC" + "GFTCB" + "FTCBG" + "TCBGF" + "CBGFT");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
    Bookshelf withHorizontalOverlappingBookshelf =
        new Bookshelf("CCCCC" + "XXXXX" + "CCCCC" + "XXXXX" + "CCCCC" + "XXXXX");
    Bookshelf withVerticalOverlappingBookshelf =
        new Bookshelf("XCXCX" + "XCCCX" + "XCCCX" + "XCCCX" + "XCCCX" + "XXCXX");
  ...
  public void SQUARES_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf twoSquaresSameTypeMatching =
        new Bookshelf("BCCTG" + "BCCGG" + "TTTGG" + "CCCCC" + "GGTTC" + "GGTBB");
    Bookshelf twoSquaresDifferentTypesMatching =
        new Bookshelf("BCCTG" + "BCCGG" + "TTTGG" + "CCCCC" + "TTTTT" + "GGGGG");
    Bookshelf noSquaresMatching =
        new Bookshelf("CBGFT" + "BGFTC" + "GFTCB" + "FTCBG" + "TCBGF" + "CBGFT");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
  ...
  public void MAX_THREE_TYPES_COLUMN_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf threeColumnMaxThreeTypesMatching =
        new Bookshelf("CBTFG" + "CBTCB" + "CBTGF" + "CBTBC" + "CBTPP" + "PPPTT");
    Bookshelf twoColumnMaxThreeTypesMatching =
        new Bookshelf("CBTFG" + "BBTCB" + "TBTGF" + "CBTBC" + "BTPPP" + "PPTTT");
    Bookshelf noColumnMaxThreeTypesMatching =
        new Bookshelf("CBGFT" + "BGFTC" + "GFTCB" + "FTCBG" + "TCBGF" + "CBGFT");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");

    assertTrue(
        SharedPatternFactory.checkMaxThreeTypesInColumn.test(threeColumnMaxThreeTypesMatching));
    assertFalse(
        SharedPatternFactory.checkMaxThreeTypesInColumn.test(twoColumnMaxThreeTypesMatching));
    assertFalse(
        SharedPatternFactory.checkMaxThreeTypesInColumn.test(noColumnMaxThreeTypesMatching));
  ...
  public void EIGHT_SAME_TYPE_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf eightSameTypeMatching =
        new Bookshelf("PPPPP" + "PPPGG" + "GGGGG" + "FFFFF" + "BBBBB" + "CCCCC");
    Bookshelf sevenSameTypeMatching =
        new Bookshelf("PPPPP" + "PPCGG" + "GGGGG" + "FFFFF" + "BBBBB" + "CCCCC");
    Bookshelf noSameTypeMatching =
        new Bookshelf("CBGFT" + "BGFTC" + "GFTCB" + "FTCBG" + "TCBGF" + "CBGFT");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
  ...
  public void DIAGONALS_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf diagonalTlbrMatching =
        new Bookshelf("PXXXX" + "XPXXX" + "XXPXX" + "XXXPX" + "XXXXP" + "XXXXX");
    Bookshelf diagonalTlbrShiftedMatching =
        new Bookshelf("XXXXX" + "CXXXX" + "XCXXX" + "XXCXX" + "XXXCX" + "XXXXC");
    Bookshelf diagonalTrblMatching =
        new Bookshelf("XXXXP" + "XXXPX" + "XXPXX" + "XPXXX" + "PXXXX" + "XXXXX");
    Bookshelf diagonalTrblShiftedMatching =
        new Bookshelf("XXXXX" + "XXXXP" + "XXXPX" + "XXPXX" + "XPXXX" + "PXXXX");
    Bookshelf noDiagonalsMatching =
        new Bookshelf("CCBGF" + "FTBFC" + "FCCGF" + "CBGFT" + "PPCBC" + "BCBPC");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
  ...
  public void MAX_THREE_TYPES_ROW_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf fourRowsMaxThreeTypesMatching =
        new Bookshelf("CCCBB" + "PBCTG" + "GGGGG" + "PTCGF" + "FFFFP" + "GGGGP");
    Bookshelf threeRowsMaxThreeTypesMatching =
        new Bookshelf("CCCBB" + "PBCTG" + "GGGGG" + "PTCGF" + "FFFFP" + "GGTCP");
    Bookshelf twoRowsMaxThreeTypesMatching =
        new Bookshelf("CCCCC" + "BBBBB" + "PTCGF" + "PTCGF" + "PTCGF" + "PTCGF");
    Bookshelf noRowMaxThreeTypesMatching =
        new Bookshelf("PTCGF" + "PTCGF" + "PTCGF" + "PTCGF" + "PTCGF" + "PTCGF");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
  ...
  public void TWO_COLUMNS_DIFF_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf twoColumnAllDiffMatching =
        new Bookshelf("PXPXT" + "CXCXT" + "FXFXF" + "BXBXB" + "GXGXG" + "TXTXX");
    Bookshelf oneColumnAllDiffMatching =
        new Bookshelf("PXXXT" + "CXXXT" + "FXXXF" + "BXXXB" + "GXXXG" + "TXXXX");
    Bookshelf noColumnAllDiffMatching =
        new Bookshelf("CCCCC" + "CCCCC" + "TTTTT" + "PPPPP" + "GGGGG" + "BBBBB");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
  ...
  @Test
  public void TWO_ROWS_DIFF_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf twoRowsAllDiffMatching =
        new Bookshelf("PCTFG" + "XXXXX" + "GPTFC" + "CCCCC" + "PTCGT" + "PTCGT");
    Bookshelf oneRowAllDiffMatching =
        new Bookshelf("PCTFG" + "XXXXX" + "GTTFC" + "CCCCC" + "PTCGT" + "PTCGT");
    Bookshelf noRowAllDiffMatching =
        new Bookshelf("CCCCC" + "CCCCC" + "TTTTT" + "PPPPP" + "GGGGG" + "BBBBB");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
  ...
  public void X_SHAPE_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf oneXShapeMatching =
        new Bookshelf("XXXXX" + "XPXPX" + "XXPXX" + "XPXPX" + "XXXXX" + "XXXXX");
    Bookshelf noXShapeMatching =
        new Bookshelf("PPPPP" + "CCCCC" + "GGGGG" + "FFFFF" + "TTTTT" + "CCCCC");
    Bookshelf nullXShapeMatching =
        new Bookshelf("PPPPP" + "CXCXC" + "GGXGG" + "TXTXT" + "FFFFF" + "BBBBB");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");
  ...
  @Test
  public void ORDERED_BOOKSHELF_RULE_satisfied()
      throws NullPointerException,
          WrongLengthBookshelfStringException,
          WrongCharBookshelfStringException {
    Bookshelf ascOrderedBookshelfMatching =
        new Bookshelf("XXXXX" + "XXXXG" + "XXXBT" + "XXCGC" + "XTBCG" + "BBBBB");
    Bookshelf ascOrderedBookshelfShiftedMatching =
        new Bookshelf("XXXXG" + "XXXBT" + "XXCGC" + "XTBCG" + "BBBBB" + "PPPPP");
    Bookshelf descOrderedBookshelfMatching =
        new Bookshelf("XXXXX" + "PXXXX" + "CGXXX" + "BGCXX" + "BGTTX" + "PPPPP");
    Bookshelf descOrderedBookshelfShiftedMatching =
        new Bookshelf("PXXXX" + "CGXXX" + "CBGXX" + "BGTTX" + "PPPPP" + "BBBBB");
    Bookshelf noOrderedBookshelfMatching =
        new Bookshelf("CCCCC" + "BBBBB" + "PTCGF" + "PTCGF" + "PTCGF" + "PTCGF");
    Bookshelf allNull = new Bookshelf("XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX" + "XXXXX");

    assertTrue(SharedPatternFactory.checkOrderedBookshelfColumns.test(ascOrderedBookshelfMatching));
    assertTrue(
        SharedPatternFactory.checkOrderedBookshelfColumns.test(ascOrderedBookshelfShiftedMatching));
    assertTrue(
        SharedPatternFactory.checkOrderedBookshelfColumns.test(descOrderedBookshelfMatching));
    assertTrue(
        SharedPatternFactory.checkOrderedBookshelfColumns.test(
            descOrderedBookshelfShiftedMatching));
  ...
  public void TEST_GET_RANDOM_SHAREDCARDS_no_duplicates()
    ...
    List<SharedPattern<Predicate<Bookshelf>>> allUsedPatterns =
        game.getSharedCard().stream()
            .map(card -> card.getPattern())
            .distinct()
