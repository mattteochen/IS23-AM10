package it.polimi.is23am10.server.items.bookshelf;

import java.util.Map;

import it.polimi.is23am10.server.items.bookshelf.exceptions.BookshelfGridColIndexOutOfBoundsException;
import it.polimi.is23am10.server.items.bookshelf.exceptions.BookshelfGridRowIndexOutOfBoundsException;
import it.polimi.is23am10.server.items.bookshelf.exceptions.NullTileException;
import it.polimi.is23am10.server.items.bookshelf.exceptions.WrongCharBookshelfStringException;
import it.polimi.is23am10.server.items.bookshelf.exceptions.WrongLengthBookshelfStringException;
import it.polimi.is23am10.server.items.tile.Tile;
import it.polimi.is23am10.server.items.tile.Tile.TileType;
import it.polimi.is23am10.server.items.tile.exceptions.WrongTileTypeException;
import it.polimi.is23am10.server.utils.IndexValidator;
import it.polimi.is23am10.server.utils.exceptions.NullIndexValueException;
